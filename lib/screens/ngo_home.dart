...
import 'package:google_solution/core/data/user_local.dart';
import 'package:google_solution/screens/Donations/available_orders.dart';
              ...
              children: [
                _OrderOption(title: 'Available Orders', icon: Icons.list_alt, onTap: () {
                  if (_currentPosition != null) {
                    ...
                    showCustomSnackBar(context,"Fetching Location. Please try again.", true);
                  }
                }),
                _OrderOption(title: 'Pending Orders', icon: CupertinoIcons.hourglass, onTap: () {}),
                _OrderOption(title: 'Create Event', icon: CupertinoIcons.create, onTap: () {}),
              ],
            ),
          ],
        ),
